...
4. Broker là gì?
5. Worker là gì?
6. Enqueue task như thế nào?
7. `delay()` khác `apply_async()` như thế nào?
8. Nếu worker không chạy thì task có được xử lý không?

1. Authentication dùng để làm gì? - dùng để xác nhận danh tính
2. Permission dùng để làm gì?  dùng để cấp quyền được phép làm không ai được phép làm và ai được phép khong làm 
3. Authentication khác Permission như thế nào - authen là dùng để xác nhận danh tính người đăng nhập là ai. Permision là dùng để cấp quyền xem user đấy được làm những gì
...
10. Khi nào nên viết method trong QuerySet, khi nào viết trong Manager?
...
17. Làm sao để thêm/bớt field trong admin?
...
32. Vì sao upload file nên dùng AJAX thay vì submit form truyền thống?
33. CSRF được xử lý như thế nào khi gọi AJAX?
34. Làm sao JavaScript hiển thị lỗi từ server trả về?
